...
function TextForm() {
  ...
  const colunas = ['Coluna', 'population', 'orbital_period', 'diameter', 'rotation_period',
  'surface_water'];
  ...
  return (
    <div>
      <Select name="column" onChange={(e) => setColumn(e.target.value)}
        ...
        options={colunas}
      />
      <Select name="comparison" onChange={(e) => setCO(e.target.value)}
        id="comparison-filter"
        options={CO}
      />
      <label htmlFor="value">
        <input name="value" type="number" data-testid="value-filter"
